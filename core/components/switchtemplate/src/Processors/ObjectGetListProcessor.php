...
class ObjectGetListProcessor extends modObjectGetListProcessor
{
    ...
    {
        if (file_exists($this->switchtemplate->getOption('corePath') . 'lexicon/' . $this->modx->getOption('manager_language', [], 'en') . '/custom.inc.php')) {
            $this->languageTopics[] = 'switchtemplate:custom';
        }
